...
// setupDifficultySelect: Handles setup difficulty select.
...
// setupKeyboardControls: Handles setup keyboard controls.
...
// getSelectedDifficulty: Handles get selected difficulty.
...
// loadHighScore: Handles load high score.
...
// saveHighScore: Handles save high score.
function saveHighScore(score) {
    localStorage.setItem(HIGH_SCORE_KEY, String(Math.max(0, Math.floor(score))));
}

// loadChaseSettings: Handles load chase settings.
...
// saveChaseSettings: Handles save chase settings.
function saveChaseSettings(settings) {
    localStorage.setItem(SETTINGS_KEY, JSON.stringify(settings));
}

// loadLeaderboard: Handles load leaderboard.
...
// addLeaderboardEntry: Handles add leaderboard entry.
